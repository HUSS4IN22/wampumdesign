...
<section className='h-screen w-full flex flex-col items-center justify-center'>
    ...
    <button className="text-2xl font-300 text-center align-center border-2 border-[#EFFAD1] text-[#320927] bg-[#EFFAD1] px-3 py-2 mt-14 rounded-full hover:bg-[#320927] hover:text-[#EFFAD1] hover:cursor-pointer transition-colors duration-300">Get Started</button>
</section>
)
}